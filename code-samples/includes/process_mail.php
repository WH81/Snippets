...
if (!$suspect) :
// Check that required fields have been filled in and reassign expected elements to simple variables 
    ...
    // If no errors, create the headers and the message body
    if (!$errors && !$missing) :
        $headers = implode("\r\n", $headers);
        // Initialize message
        $message = '';
...
// Check out using Regular Expressions on Lynda.com
